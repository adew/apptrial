...
--
-- Host: 127.0.0.1
-- Generation Time: May 06, 2021 at 08:00 AM
...
INSERT INTO `tb_pengajuan_cuti` (`id`, `nip`, `nama`, `tgl_awal`, `tgl_akhir`, `lama_cuti`, `saldo_cuti`, `jenis_cuti`, `keterangan`, `status_cuti`, `creat_at`) VALUES
(1, '123', 'ADE WIDIANTO, A.Md. ', '2021-05-06', '2021-05-08', 2, 12, 'Bulanan', 'Cuti mendadak', 1, '06-05-2021');
...
(28, '', 'ADE WIDIANTO, A.Md. ', '123', 'Pengadministrasi Registrasi Perkara ', 'Panitera Muda Pidana Pengadilan Militer III - 18 Ambon ', 'Screenshot_(1).png', '', '$2y$10$HmwlhxIZ0hxRlgzMt4w3jOuZZWELRs3sbAaul2OUdXTSStF9iNhiq', 1, '06-05-2021 1:24'),
