                  ...
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="input-departemen.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Id Jenis Cuti</label>
                              <div class="col-sm-8">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="departemen" type="text" id="departemen" class="form-control" placeholder="Jenis Cuti" autocomplete="off" required />
