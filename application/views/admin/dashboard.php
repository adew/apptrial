  ...
  <section class="content">
    <div class="row">
      <section class="col-lg-12 connectedSortable">
        <div class="scroller box box-warning" style="overflow-y: scroll; max-height:440px;">
          <div class="box-body">
            <?php foreach ($list_data as $list => $value) : ?>
              <ul class="users-list">
                <!-- <div class="col-md-3 col-sm-6 col-xs-12"> -->
                <!-- <div class="col"> -->
                <li class="col-md-3 col-sm-6 col-xs-12"><a href="<?= base_url('pkp/details/') . $value->nip ?>">
                    ...
                    <span class="users-list-date" style="display: block;">NIP <?= $value->nip ?></span></a>
                </li>
                <!-- </div> -->
                <!-- </div> -->
              </ul>
