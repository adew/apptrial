...
--
-- Host: 127.0.0.1
-- Generation Time: May 05, 2021 at 08:13 AM
...
CREATE TABLE `tb_pengajuan_cuti` (
  ...
  `jml_cuti` int(25) NOT NULL,
  `saldo_cuti` int(25) NOT NULL,
  `jenis_cuti` varchar(150) NOT NULL,
  `keterangan` int(150) NOT NULL,
...
(28, '', 'ADE WIDIANTO, A.Md. ', '123', 'Pengadministrasi Registrasi Perkara ', 'Panitera Muda Pidana Pengadilan Militer III - 18 Ambon ', 'Screenshot_(1).png', '', '$2y$10$HmwlhxIZ0hxRlgzMt4w3jOuZZWELRs3sbAaul2OUdXTSStF9iNhiq', 1, '05-05-2021 7:10'),
